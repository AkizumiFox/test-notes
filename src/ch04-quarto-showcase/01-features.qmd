...
*Matrix Classification Flowchart:*

Matrix A $\rightarrow$ Is A symmetric?

- **Yes** $\rightarrow$ Real eigenvalues
- **No** $\rightarrow$ Is A normal?
  - **Yes** $\rightarrow$ Orthogonal eigenvectors
  - **No** $\rightarrow$ May not be diagonalizable
:::
